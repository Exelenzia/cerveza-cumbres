<div class="max-w-3xl space-y-6">
    ...
    <div class="rounded-xl border border-border bg-surface-elevated p-6">
        <h2 class="mb-1 font-display text-lg uppercase tracking-wide text-text">Meta WhatsApp Cloud API</h2>
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            <div>
                ...
                <input type="text" wire:model="phone_number_id" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div>
                ...
                <input type="text" wire:model="business_account_id" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="password" wire:model="access_token" placeholder="{{ $whatsappSetting?->phone_number_id ? '••••••••' : '' }}" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div>
                ...
                <input type="text" wire:model="wa_link_phone" placeholder="51999999999" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div>
                ...
                <input type="text" wire:model="template_language" placeholder="es" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
    ...
    <div class="rounded-xl border border-border bg-surface-elevated p-6">
        <h2 class="mb-1 font-display text-lg uppercase tracking-wide text-text">Plantillas de notificación</h2>
        ...
        <div class="grid gap-4 sm:grid-cols-3">
            <div>
                ...
                <input type="text" wire:model="template_confirmacion" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div>
                ...
                <input type="text" wire:model="template_enviado" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div>
                ...
                <input type="text" wire:model="template_entregado" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
    ...
    <div class="rounded-xl border border-border bg-surface-elevated p-6">
        <label class="flex items-center gap-3 text-sm text-text-muted">
            <input type="checkbox" wire:model="is_active" class="h-4 w-4 rounded border-border bg-surface text-primary focus:ring-primary">
            Integración activa
        </label>
    </div>
