            ...
            <form wire:submit="save" class="space-y-4">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" wire:model="name" placeholder="Lima Metropolitana" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
                ...
                <div>
                    ...
                    <textarea wire:model="cities" rows="2" placeholder="Lima, Callao, San Isidro" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none"></textarea>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" wire:model="eta_label" placeholder="24 horas" class="w-full rounded-lg border border-border bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
                    </div>
                    <div>
            ...
            <tbody class="divide-y divide-border">
                @forelse ($zones as $zone)
                    <tr class="bg-surface/40">
                        ...
                        <td class="px-4 py-3">
                            <span class="rounded-full px-2 py-1 text-xs {{ $zone->is_active ? 'bg-green-500/20 text-green-300' : 'bg-surface-muted text-text-muted/60' }}">
