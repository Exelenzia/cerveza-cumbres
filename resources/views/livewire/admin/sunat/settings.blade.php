<div class="max-w-3xl space-y-6">
    ...
    @if ($certificadoError)
        <div class="card-brutal border-red-500/40 bg-red-500/10 px-4 py-3 text-sm text-red-300">
            {{ $certificadoError }}
        </div>
    @endif

    <div class="card-brutal bg-surface-elevated p-6">
        <h2 class="mb-1 font-display text-lg font-bold uppercase tracking-wide text-text">Datos del emisor</h2>
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            <div>
                ...
                <input type="text" wire:model="ruc" maxlength="11" class="w-full border-[2px] border-text bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div>
                ...
                <input type="text" wire:model="razon_social" class="w-full border-[2px] border-text bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" wire:model="nombre_comercial" class="w-full border-[2px] border-text bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" wire:model="direccion" class="w-full border-[2px] border-text bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div>
                ...
                <input type="text" wire:model="ubigeo" maxlength="6" class="w-full border-[2px] border-text bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div>
                ...
                <input type="text" wire:model="departamento" class="w-full border-[2px] border-text bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div>
                ...
                <input type="text" wire:model="provincia" class="w-full border-[2px] border-text bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div>
                ...
                <input type="text" wire:model="distrito" class="w-full border-[2px] border-text bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
    ...
    <div class="card-brutal bg-surface-elevated p-6">
        <h2 class="mb-1 font-display text-lg font-bold uppercase tracking-wide text-text">Credenciales SOL y certificado</h2>
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            <div>
                ...
                <input type="text" wire:model="sol_usuario" class="w-full border-[2px] border-text bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div>
                ...
                <input type="password" wire:model="sol_clave" placeholder="{{ $sunatSetting?->sol_usuario ? '••••••••' : '' }}" class="w-full border-[2px] border-text bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
            ...
            <div>
                ...
                <input type="file" wire:model="certificado" class="w-full border-[2px] border-text bg-surface px-3 py-2 text-text file:mr-3 file:border-0 file:bg-primary file:px-3 file:py-1 file:text-primary-on">
            ...
            <div>
                ...
                <input type="password" wire:model="certificado_password" placeholder="{{ $sunatSetting?->certificado_path ? '••••••••' : '' }}" class="w-full border-[2px] border-text bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
    ...
    <div class="card-brutal bg-surface-elevated p-6">
        <h2 class="mb-1 font-display text-lg font-bold uppercase tracking-wide text-text">Ambiente</h2>
        <p class="mb-4 text-sm text-text-muted/60">Usa el ambiente beta para pruebas antes de emitir comprobantes reales.</p>

        <select wire:model="modo" class="w-full max-w-xs border-[2px] border-text bg-surface px-3 py-2 text-text focus:border-primary focus:outline-none">
    ...
    @if ($series->isNotEmpty())
        <div class="card-brutal bg-surface-elevated p-6">
            <h2 class="mb-4 font-display text-lg font-bold uppercase tracking-wide text-text">Series de comprobantes</h2>
            <table class="w-full text-left text-sm">
                <thead class="font-display font-bold uppercase tracking-wide text-text-muted/60">
                    <tr>
                ...
                <tbody class="text-text">
                    @foreach ($series as $serie)
                        <tr class="border-t-[2px] border-text/20">
